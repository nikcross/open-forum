...
var PageBlockEditor = function(data, parentId) {
  ...
  OpenForum.addScript( "/OpenForum/AddOn/ContentEditor/TextBlockEditor.js" )
    .addScript( "/OpenForum/AddOn/ContentEditor/PageTitleBlockEditor.js" )
    .addScript( "/OpenForum/AddOn/ContentEditor/WYSIWYGBlockEditor.js" )
    .addScript( "/OpenForum/AddOn/ContentEditor/TwoColumnBlockEditor.js" )
    .addScript( "/OpenForum/AddOn/ContentEditor/SectionBlockEditor.js" )
    .addScript( "/OpenForum/AddOn/ContentEditor/InsertPageBlockEditor.js" )
    .go();
  ...
  self.initView = function( elementId ) {
    ...
    view += self.renderAddButton( elementId, "add", false);
    for( var i in data.content ) {
      ...
      view += self.renderAddButton( data.content[i].elementId, "addAfter", true);
    }
    view += "</div>";
...
PageBlockEditor.prototype = new BlockPrototype("page");
