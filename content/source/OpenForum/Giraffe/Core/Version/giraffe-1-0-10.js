//==============================================================================================================//
/* Version 1.0.10*/
/* Built on Tue May 09 2017 15:56:23 GMT-0000 (GMT) */
...
//==============================================================================================================//
//==============================================================================================================//
/* Source: /OpenForum/Giraffe/Core/pixel-canvas.js*/
//==============================================================================================================//
/*
* Author: 
* Description: 
...
/* End of: /OpenForum/Giraffe/Core/pixel-canvas.js*/
...
function Composite(x,y,rotation)
{
  ...
  this.isInside = function(posX,posY) {
    var relativePosX = (posX / this.scaleX)-this.x;
    var relativePosY = (posY / this.scaleY)-this.y;
