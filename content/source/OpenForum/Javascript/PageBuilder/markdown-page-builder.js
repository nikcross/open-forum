/*
* Author: Nik Cross
* Description: Takes the page.content file and converts it to html using the markdown wiki syntax
*/
...
try{
  ...
  var renderer = js.getObject("/OpenForum/Javascript/Renderer","MarkDownRenderer.sjs");
