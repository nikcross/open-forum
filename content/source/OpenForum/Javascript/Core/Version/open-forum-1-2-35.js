//==============================================================================================================//
/* Version 1.2.35*/
/* Built on Tue Oct 17 2017 14:55:13 GMT-0000 (GMT) */
...
var OpenForum = new function(){
  ...
  self.getBuildDate = function() {
    return "Tue Oct 17 2017 14:55:13 GMT-0000 (GMT)";
  };
...
function OpenForumTable(node) {
  ...
  this.refresh = function() {
    ...
    try {
      if(this.tableNode.attributes && this.tableNode.attributes['of-id'] && typeof this.tableNode.value != "undefined" ) {
