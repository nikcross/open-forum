//==============================================================================================================//
/* Version 1.1.26*/
/* Built on Mon Mar 20 2017 15:50:31 GMT-0000 (GMT) */
...
var OpenForum = new function(){
  ...
  self.getBuildDate = function() {
    return "Mon Mar 20 2017 15:50:31 GMT-0000 (GMT)";
  };
...
function OpenForumTable(node) {
  ...
  if(this.tableNode.attributes && this.tableNode.attributes['of-id']) {
    this.tableNode.id=this.tableNode.attributes['of-id'].value;
