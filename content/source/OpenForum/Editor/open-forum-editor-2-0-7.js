//==============================================================================================================//
/* Version 2.0.7*/
/* Built on Fri Nov 29 2019 12:59:48 GMT-0000 (GMT) */
...
function openAttachment(attachmentId) {
  ...
  if(editor===null) {
    ...
    if(fileName.indexOf(".link")==fileName.length-5) {
      ...
      flavour = "sql";
    } else if(fileName.indexOf(".py")==fileName.length-4) {
      flavour = "python";
    } else if(fileName.indexOf(".wiki")==fileName.length-5) {
      flavour = "html";
    } else if(fileName.indexOf(".wiki.fragment")==fileName.length-5) {
      flavour = "html";
    } else if(fileName.indexOf(".wiki.template")==fileName.length-5) {
      flavour = "html";
...
OpenForum.focusOnSearch = function() { 
  document.getElementById("OpenForumSearch").display = "block";
...
function HTMLEditor(editorIndex,pageName,fileName,markChanged) {
  ...
  self.documentation = [
    ...
    {pageName: "/OpenForumMarkup/ExtendedWikiMarkup", title: "OpenForum Extended Markup"},
