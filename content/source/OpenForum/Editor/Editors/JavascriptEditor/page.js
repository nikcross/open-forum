...
var editingPageName = "/TheLab/JavascriptEditor";
var editingFileName = "editing.js";
var autoSave = true;

OpenForum.init = function() {
  document.getElementById("javascriptEditor").innerHTML = OpenForum.loadFile("/OpenForum/Editor/Editors/JavascriptEditor/standalone.page.html");
  OpenForum.crawl(document.getElementById("javascriptEditor"));
  ...
  editor = new JavascriptEditor(0,editingPageName,editingFileName);
