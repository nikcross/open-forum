//==============================================================================================================//
/* Version 2.0.22*/
/* Built on Mon Sep 20 2021 16:48:10 GMT-0000 (GMT) */
...
function addEditor(newPageName,fileName,flavour) { 
...
//==============================================================================================================//
//==============================================================================================================//
/* Source: /OpenForum/Editor/editor-config.js*/
//==============================================================================================================//
/*
* Author: 
* Description: 
...
function openEditorConfig() {
  for( var e in editorConfig.editors ) {
    ...
    if( editorDef.type == "editor" ) {
    	addEditor( editorDef.pageName, editorDef.fileName, editorDef.flavour );
  	} else if( editorDef.type == "plugin" ) {
    	loadPlugin( editorDef.name );
  	}
  }
...
function saveEditorConfig() {
  ...
  for( var e in editorList ) {
    ...
    if(editor.attachment) {
      editorConfig.editors.push( { type: "editor", pageName: editor.attachment.pageName, fileName: editor.attachment.fileName, flavour: editor.attachment.flavour} );
    } else if(editor.plugin) {
      editorConfig.editors.push( { type: "plugin", name: editor.name } );
    }
  }
  
  OpenForum.saveJSON( editorConfig.pageName + "/" + editorConfigFile, editorConfig, function() { alert("Editor configuration saved to " + editorConfig.pageName + "/" + editorConfigFile ); } );
}

/* End of: /OpenForum/Editor/editor-config.js*/
