if( typeof javascriptBuilder === "undefined" ) {
  
var javascriptBuilder = {
  open: false,
  close: function() {
    javascriptBuilder.open = false;
  }
};
...
addPlugin( {
  ...
  init: function() {
    ...
    editorList[editorIndex] = {id: editorIndex, tabButtonStyle: "tab", tabId: "editor"+editorIndex, name: "Javascript Builder", changed: "", plugin: javascriptBuilder};
    showTab(editorIndex);
  ...
  for(var i in editorList) {
    if(editorList[i].name==="Javascript Builder") {
