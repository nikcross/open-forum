...
* Description: v0.0.0
*/
var ClockBlockEditor = function(data, parentId) {
  var self = this;
  self.setData( data );
  ...
  self.initView = function(elementId) { 
    ...
    data.treeNode.setName( self.renderHighlightLink( elementId + "_content", data.treeNode.getName(), "Clock" ) );
...
self.render = function() {
  var content = "[{/OpenForum/Extensions/Clock }]";

  return content;
};
};

ClockBlockEditor.prototype = new BlockPrototype("","{{blockIcon}}");

ClockBlockEditor.template = {
  "block": "clock",
  "data": {
